#!/bin/bash
#SBATCH --job-name=gnn_vs_dp_actions
#SBATCH --output=things_to_improve_Q_star_experiments/action_compare/results/slurm_%A_task%a.log
...
# GNN-Q vs exact-DP action comparison logs (no training).
# 6 tasks:
...
/net/projects/ranalab/rajhansini/conda_envs/genetic-rl/bin/python \
  things_to_improve_Q_star_experiments/action_compare/log_gnn_vs_dp.py \
